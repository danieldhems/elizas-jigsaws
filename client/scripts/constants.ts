...
export const PUZZLE_SIZE_LANDSCAPE_VIEWPORT_LANDSCAPE_IMAGE = 70;
export const PUZZLE_SIZE_LANDSCAPE_VIEWPORT_PORTRAIT_IMAGE = 50;
export const PUZZLE_SIZE_PORTRAIT_VIEWPORT_PORTRAIT_IMAGE = 70;
export const PUZZLE_SIZE_PORTRAIT_VIEWPORT_LANDSCAPE_IMAGE = 50;
export const PUZZLE_SIZE_SQUARE_IMAGE = 60;
