...
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__LANDSCAPE_VIEWPORT__LANDSCAPE_IMAGE = 60;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__LANDSCAPE_VIEWPORT__PORTRAIT_IMAGE = 60;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__LANDSCAPE_VIEWPORT__SQUARE_IMAGE = 50;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__PORTRAIT_VIEWPORT__LANDSCAPE_IMAGE = 50;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__PORTRAIT_VIEWPORT__PORTRAIT_IMAGE = 60;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__PORTRAIT_VIEWPORT__SQUARE_IMAGE = 50;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__SQUARE_VIEWPORT__LANDSCAPE_IMAGE = 50;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__SQUARE_VIEWPORT__PORTRAIT_IMAGE = 50;
export const SOLVING_AREA_SIZE_AS_PERCENTAGE_OF_VIEWPORT__SQUARE_VIEWPORT__SQUARE_IMAGE = 50;
