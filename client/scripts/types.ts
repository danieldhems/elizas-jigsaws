...
export type PathPartBezierControlPointRelative =
   `c ${PathPartControlPoint} ${PathPartControlPoint} ${PathPartControlPoint}`;
export type PathPartControlPoint = `${number} ${number}`;
export type PathParts = PathPartHorizontalRelative | PathPartVerticalRelative | PathPartBezierControlPointRelative | '';
